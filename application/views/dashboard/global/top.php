<div id="top">
    <div class="wrapper">
        <a href="index.html" title="" class="logo">
            <img id="logo-kbb" src="<?php echo base_url('assets/admin/images/rsz_logo_kbb.png'); ?>" alt="" />
            <img id="logo-bpmppt" src="<?php echo base_url('assets/admin/images/simbpmppt.png'); ?>" alt="" />
        </a>

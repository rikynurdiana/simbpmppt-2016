    ...
    <div id="content">
        ...
        <div class="breadLine">
            <div class="bc">
                <ul id="breadcrumbs" class="breadcrumbs">
                    ...
                    <li><a href="<?php echo base_url('dashboard/master'); ?>">Master DPA</a></li>
                </ul>
            </div>
        ...
        <div class="wrapper">
            ...
            <?php else: ?>
                <div class="widget">
                    <div class="whead">
                        <h6><?php echo strtoupper("RINCIAN MASTER DPA"); ?></h6>
                        <span class="whead-right">Total : Rp.<?php echo number_format($global_count['total_volume']->volume*$global_count['total_harga']->harga); ?></span>
                        <div class="clear"></div>
                    </div>
